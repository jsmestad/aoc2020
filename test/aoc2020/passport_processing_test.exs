defmodule Aoc2020.PassportProcessingTest do
  use ExUnit.Case

  alias Aoc2020.PassportProcessing
  ...
  test "part_one/1" do
    assert 2 == test_input() |> PassportProcessing.part_one()
    assert 250 == real_input() |> PassportProcessing.part_one()
  end

  test "part_two/1" do
    assert 4 == part_two_test_input() |> PassportProcessing.part_two()
    assert 2 == real_input() |> PassportProcessing.part_two()
  end

  test "part_two/1 valid" do
    assert """
           pid:087499704 hgt:74in ecl:grn iyr:2012 eyr:2030 byr:1980
           hcl:#623a2f
           ...
           iyr:2010 hgt:158cm hcl:#b6652a ecl:blu byr:1944 eyr:2021 pid:093154719
           """
           |> PassportProcessing.part_two() == 4
  end

  test "part_two/1 invalid" do
    assert """
           eyr:1972 cid:100
           hcl:#18171d ecl:amb hgt:170 pid:186cm iyr:2018 byr:1926
